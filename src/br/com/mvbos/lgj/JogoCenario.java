...
public class JogoCenario extends CenarioPadrao {
	...
	private static Direcao prxDirecao = Direcao.OESTE;

	private int temporizadorPizza;
	private static int temporizadorFantasma;

	private static Pizza pizza;

	private static Pizza[] inimigos;
	...
	private static Estado estado = Estado.JOGANDO;
	...
	private static boolean superPizza;
	...
	public void carregar() {
		...
		inimigos[0].setVel(2 + Jogo.nivel);
		inimigos[0].setAtivo(false);
		inimigos[0].setCor(Color.RED);
		inimigos[0].setDirecao(Direcao.SUL);
		inimigos[0].setModo(Pizza.Modo.PRESO);
		...
		inimigos[3].setCor(Color.ORANGE);
		inimigos[3].setDirecao(Direcao.OESTE);
	...
	private static int converteInidicePosicao(int linhaColuna) {
