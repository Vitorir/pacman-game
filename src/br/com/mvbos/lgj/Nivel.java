...
public class Nivel {
	...
	/** Ponto inicialdo inimigo 3*/
	public static final int P3 = 10;
	/**Ponto inicial do inimigo 4*/
	...
	public static int[][] cenario = {
		...
		{ EV, EV, EV, EV, EV, BL, CN, BL, BL, EV, EV, EV, EV, PF, EV, EV, EV, EV, EV, BL, BL, CN, BL, EV, EV, EV, EV, EV },
		...
		{ CN, CN, CN, CN, CN, CN, CN, CN, CN, EV, BL, P3, EV, EV, EV, P4, EV, BL, EV, CN, CN, CN, CN, CN, CN, CN, CN, CN },
		{ BL, BL, BL, BL, BL, BL, CN, BL, BL, EV, BL, EV, P2, PV, P1, EV, EV, BL, EV, BL, BL, CN, BL, BL, BL, BL, BL, BL },
